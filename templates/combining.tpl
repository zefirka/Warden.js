<div class="container">
  <div class="row">
    ...
    <div class="col-md-9 col-sm-9 col-xs-12 col-lg-10">
      ...
      <p>We create two streams from events. Sometimes we need to produce value from given by some function, but we don't want to cache previous state. To avoid state use combine method.</p>
