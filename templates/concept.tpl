<div class='row'>
	<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
		...
		<p>One of the common solutions for JavaScript is the implementation of functional reactive programming ideas. FRP suggest that you will use pure functional approach. In terms of FRP there is no events. There is a source of data which partial case events are.</p>
		<p>Main difference between traditional event driven programming and FRP are pure functions as stream handlers, changes propagation as mechanism of state updating. If you're using React - you can find out that idea of Virtual DOM is pretty much looks like functional approach state managment. It's not suprising because really functional approach will make you construct your apps in way where all state changes will be changes of view. There is a realy good stack: React + ClojureScript + Javelin, where all stores in React are Cells of Javelin </p> 
		<div class='g-img-container'>
