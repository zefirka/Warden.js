<div class='row'>
	<div class="col-md-12 col-sm-12 col-xs-12 col-lg-12">
		...
		<h2>Trade-off</h2>
		<p>К сожалению, у нас не всегда есть возможность использовать FRP в том виде, в котором он реализован на JavaScript. Как правило внедрение "элементов" FRP может оставить неприятный осадок.</p>
