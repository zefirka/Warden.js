<div class="container">
  <div class="row">
    <div class="col-md-12">
      <h2>Concept</h2>
      <p>Warden.js is a library to make event-driven programming clear, declarative and easy.</p>
      <p>General idea of Warden.js to make composing, combining and resolving concurrent events simpler. In mathematical sense, idea that to change your app's representation from tree of states to the partially ordered set of events in time (or other) priority relation. It means that in Warden.js events are data which changes in time, not an actions which publish data to handlers.</p>
    </div>
    <div class="col-md-12">
      <h2>Rationale</h2>
      <ul id='rationale'>
